...
Revision ID: 90a9edeb34e4
Revises: 
Create Date: 2024-03-15 19:54:21.843484
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('is_assignor', sa.Boolean(), server_default=sa.text('false'), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['person.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
